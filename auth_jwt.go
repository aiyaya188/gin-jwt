...
type GinJWTMiddleware struct {
	...
	LoginResponseData func(c *gin.Context, code int, message string, uid uint64, time time.Time)
...
func (mw *GinJWTMiddleware) LoginHandlerData(c *gin.Context) {
	...
	mw.LoginResponseData(c, http.StatusOK, tokenString, uint64(claims["userID"].(float64)), expire)
}
